...
namespace DAL_PolyCafe
{
    public class DBUtil
    {
        public static string connString = @"Data Source=LAPCUANBNHAAAAA\SQLEXPRESS;Initial Catalog=PolyCafe1;Integrated Security=True;Trust Server Certificate=True";
