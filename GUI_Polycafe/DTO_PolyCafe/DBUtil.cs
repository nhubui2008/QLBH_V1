...
namespace DTO_PolyCafe
{
    public class DBUtil
    {
        public static string connString = @"Data Source=DESKTOP-NPO91IS\SQLEXPRESS;Initial Catalog=PolyCafe;Integrated Security=True;Trust Server Certificate=True";
